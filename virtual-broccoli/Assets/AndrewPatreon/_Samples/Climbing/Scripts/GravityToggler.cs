...
/// <summary>
/// Since the vertical gravity in the move provider accumlates even when it's not in use,
/// we need to disable the gravity when climbing so the player doesn't snap to the ground when releasing.
/// </summary>
