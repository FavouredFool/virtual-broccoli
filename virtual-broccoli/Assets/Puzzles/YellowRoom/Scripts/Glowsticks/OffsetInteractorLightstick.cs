...
public class OffsetInteractorLightstick : XRGrabInteractable
{
    ...
    private IEnumerator LaunchRoutine()
    {
        ...
        // Once the lightstick has stopped flying
        DisablePhysics();
        ChildArrow(hit);
    ...
    {
        if (hit.transform.TryGetComponent(out ILightStickHittable hittable))
            hittable.Hit(this);
    }
